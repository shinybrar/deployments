...
| `redis` | [Redis sub-chart configuration](https://github.com/bitnami/charts/tree/main/bitnami/redis) for Skaha's caching of Harbor Docker image metadata. | <pre><code>architecture: 'standalone'<br />auth:<br />&nbsp;&nbsp;enabled: false<br />master:<br />&nbsp;&nbsp;persistence:<br />&nbsp;&nbsp;&nbsp;&nbsp;enabled: false<br />&nbsp;&nbsp;containerSecurityContext:<br />&nbsp;&nbsp;&nbsp;&nbsp;runAsUser: 1001<br />&nbsp;&nbsp;&nbsp;&nbsp;runAsGroup: 1001<br />&nbsp;&nbsp;&nbsp;&nbsp;runAsNonRoot: true<br />&nbsp;&nbsp;&nbsp;&nbsp;allowPrivilegeEscalation: false<br />&nbsp;&nbsp;&nbsp;&nbsp;readOnlyRootFilesystem: true<br />&nbsp;&nbsp;&nbsp;&nbsp;seccompProfile:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;type: RuntimeDefault<br />&nbsp;&nbsp;&nbsp;&nbsp;capabilities:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;drop: ["ALL"]</code></pre> |
